...
namespace Kogler.Framework
{
    ...
    public interface IRecursiveCollection : IList
    {
        IRecursiveContainer Container { get; }
    }

    public interface IRecursiveCollection<TEntity> : IList<TEntity>, INotifyPropertyChanged, INotifyCollectionChanged, IRecursiveCollection where TEntity : IRecursive//, IPosition
    {
